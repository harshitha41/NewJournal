...
@media screen and (max-width: 600px) {
	.col-25, .col-75, input[type=submit], .col-15, .col-40 {
		width: 100%;
		margin-top: 0;
	}
}
			...
			<form action="<c:out value="${addURL}"></c:out>" method="post">
				...
				<div class="row">
					...
					<div class="col-40-radio"><span class="mand">*</span>
						...
						<input id="ffs" type="radio" value="FullTimeStudent" name="fauthor">Full Time Student
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-40-radio">
						...
						<input id="sfs" type="radio" value="FullTimeStudent" name="sauthor">Full Time Student
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-40-radio">
						...
						<input id="tfs" type="radio" value="FullTimeStudent" name="tauthor">Full Time Student
					</div>
