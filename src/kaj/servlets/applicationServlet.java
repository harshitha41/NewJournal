...
public class applicationServlet extends HttpServlet 
	{
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
		{
			...
			//application newapplication = new application(name, email, country);
			...
			MongoDBApplicationDAO applicationDAO = new MongoDBApplicationDAO(mongo);
			applicationDAO.createApplication(a);
			...
			List<application> applications = applicationDAO.readAllApplication();
			request.setAttribute("Applications", applications);
			//response.sendRedirect(request.getContextPath() + "/viewApplication.jsp");
			RequestDispatcher rd = getServletContext().getRequestDispatcher("/viewApplication.jsp");
			rd.forward(request, response); */
